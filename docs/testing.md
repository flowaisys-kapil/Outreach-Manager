...
This document describes the testing setup and conventions for Outreach Manager.
...
pythonpath = .
testpaths = tests
DJANGO_SETTINGS_MODULE = outreach_manager.settings
```
...
├── test_emails.py           # Email utilities

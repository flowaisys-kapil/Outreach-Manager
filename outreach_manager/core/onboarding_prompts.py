...
from outreach_manager.core.onboarding_wizard import (
    Confirm,
    IntText,
    MultilineText,
    Password,
...
# central contacts store contribution is disabled.
CONNECT_DAILY = IntText("connect_daily_limit", "LinkedIn connection requests daily limit", default=50)
CONNECT_WEEKLY = IntText("connect_weekly_limit", "LinkedIn connection requests weekly limit", default=100)
